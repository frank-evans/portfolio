const styles = {
    ...
    /* heroHeadText:
      "font-black text-white lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-2 z-5",
    heroSubText:
      "text-[#dfd9ff] font-medium lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px] z-5", */
    heroHeadText:
      "font-black text-white lg:text-[40px] sm:text-[24px] text-[14px] lg:leading-[50px] mt-2 z-5",
    heroSubText:
